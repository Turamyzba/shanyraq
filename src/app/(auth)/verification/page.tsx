        ...
        <div className="w-full flex items-center justify-center">
            <div className="max-w-[720px] rounded-2xl py-[70px] px-[100px]">
                <div className="mb-5 text-center">
                    ...
                    <p className="text-[#B5B7C0] text-base">Пожалуйста, введите 6-значный код, отправленный на ваш
                        электронный адрес.</p>
                </div>
                ...
                <Form onSubmit={handleSubmit} className={'gap-3.5'}>
                    ...
                    <MyButton type={'submit'}
                              className={"bg-primary text-white w-full rounded font-bold"}>Потвердить</MyButton>
                    <MyButton className={"bg-white text-black w-full rounded font-bold"}>Отправить код
                        повторно</MyButton>
                </Form>
            </div>
        </div>

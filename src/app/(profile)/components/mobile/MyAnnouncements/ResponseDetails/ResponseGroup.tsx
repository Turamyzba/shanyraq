    ...
    <div className={styles.groupCard}>
      ...
      {group.newApplications.length > 0 && (
        <div className={styles.newApplicationsSection}>
          <Button className={styles.newAppsButton}>Новые заявки</Button>

          <Collapse className={styles.newAppsCollapse} ghost expandIconPosition="end">
            <Panel
              header={<div className={styles.invisibleHeader}></div>}
              key="newApps"
              className={styles.newAppsPanel}
            >

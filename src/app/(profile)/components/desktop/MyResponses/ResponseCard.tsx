      ...
      <div className={styles.content}>
        ...
        <div className={styles.details}>
          <div className={styles.detailItem}>
            <CalendarIcon />
            <span>Дата заявки: {response.applicationDate}</span>
          </div>
          <div className={styles.detailItem}>
            <UserIcon />
            <span>Владелец: {response.ownerName}</span>
          </div>
          <div className={styles.detailItem}>
            <PeopleIcon />
            <span>Участников: {response.memberCount}</span>
          </div>
          <div className={styles.detailItem}>
            <GroupIcon />
            <span>{response.isGroupCreator ? "Вы создатель группы" : "Участник группы"}</span>
          </div>
        </div>

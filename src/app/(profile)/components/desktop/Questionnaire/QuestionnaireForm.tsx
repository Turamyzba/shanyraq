      ...
      {step < 3 && (
        <>
          ...
          <div className={styles.btnRow}>
            {step === 1 ? (
              <Button className={styles.previousBtn} onClick={handleCancel}>
                Отменить
              </Button>
            ) : (
              <Button className={styles.previousBtn} onClick={handleBack}>
                Назад
              </Button>
            )}
            {step === 1 ? (
              ...
              <Button className={styles.nextBtn} type="primary" onClick={handleSubmit}>
                Сохранить и выйти
              </Button>
            )}
          </div>
      ...
      {step === 3 && (
        <div className={styles.successContainer}>
          ...
          <div className={styles.btnSuccess}>
            <Button className={styles.reinput} onClick={handleRetake}>
              Заполнить заново
            </Button>
            <Button className={styles.preview} type="primary" onClick={openViewModal}>
              Посмотреть
            </Button>
          </div>
        </div>
